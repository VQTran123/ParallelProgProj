...
void rank_merge(long **sendbuf, long *recvbuf, int count, MPI_Datatype datatype, MPI_Comm comm, int step) {
    int rank;
...
int main(int argc, char** argv) {
    ...
    */
    ...
    while(step < size) {
        ...
        rank_merge(&buffer, placeholder_array, elements*step, MPI_LONG, MPI_COMM_WORLD, step);
        step *= 2;
    }
