...
// link cuda functions to the mpi program
...
int main(int argc, char** argv) {
    ...
    long* buffer; // array for each rank to store their partitions of elements and the final variable that stores the entire array of sorted elements
